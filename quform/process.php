 ...
 *
 * You can add multiple email addresses by adding one on each line inside the
 ...
 * );
 */
$config['recipients'] = 'info@physicianschoice-healthcare.com';
 ...
 */
$config['emailHtml'] = '/emails/email-html.php';

/**
 * The file containing the plain text body of the notification email
 */
$config['emailPlain'] = '/emails/email-plain.php';
 ...
 */
$config['autoreplyHtml'] = '/emails/autoreply-html.php';

/**
 * The file containing the plain text body of the autoreply email
 */
$config['autoreplyPlain'] = '/emails/autoreply-plain.php';
 ...
 */
$config['smtp'] = array(
    'host' => 'mail.enmail.com',
    'port' => '25',
    'username' => 'infotronics@enmail.com',
    'password' => 'tronics123',
    'encryption' => ''
);
        ...
        try {
            ...
            if ($config['autoreply']) {
                ...
                if ($autoreplyRecipient['email']) {
                    ...
                    // Set the message body HTML
                    ob_start();
                    include QUFORM_ROOT . $config['autoreplyHtml'];
                    $mailer->MsgHTML(ob_get_clean());

                    // Add a plain text part for non-HTML email readers
                    ob_start();
                    include QUFORM_ROOT . $config['autoreplyPlain'];
                    $mailer->AltBody = ob_get_clean();
